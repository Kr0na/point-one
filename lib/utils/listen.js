  ...
  return function (Component) {
    ...
    return _temp = _class = function (_Component) {
      ...
      function WrappedComponent(props, context, updater) {
        ...
        _this.store = providedStore || context.store;
        var _storeState = stateGetter(_this.store.getState());
        _this.state = _extends({}, _this.state, _storeState, {
      ...
      _createClass(WrappedComponent, [{
        ...
        value: function componentDidMount() {
          ...
          this._listeners.push(this.store.listen(function (state) {
            state = stateGetter(state);
            if (_this2.state._storeState !== state) {
        ...
        value: function componentWillUnmount() {
          _get(Object.getPrototypeOf(WrappedComponent.prototype), 'componentWillUnmout', this) && _get(Object.getPrototypeOf(WrappedComponent.prototype), 'componentWillUnmout', this).call(this);
  ...
  if (Array.isArray(stateGetter)) {
    (function () {
      ...
      stateGetter = function stateGetter(state) {
        ...
        return fields.reduce(function (target, key) {
          return _extends({}, target, _defineProperty({}, key, state[key]));
        }, {});
      };
    })();
  }
