...
function makeWrapper() {
  var providedStore = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  return function (Component) {
    ...
    return _temp = _class = function (_Component) {
      ...
      function WrappedComponent(props, context, updater) {
        ...
        var _this = _possibleConstructorReturn(this, (WrappedComponent.__proto__ || Object.getPrototypeOf(WrappedComponent)).call(this, props, context, updater));
      ...
      _createClass(WrappedComponent, [{
        ...
        value: function componentDidMount() {
          ...
          _get(WrappedComponent.prototype.__proto__ || Object.getPrototypeOf(WrappedComponent.prototype), 'componentDidMount', this) && _get(WrappedComponent.prototype.__proto__ || Object.getPrototypeOf(WrappedComponent.prototype), 'componentDidMount', this).call(this);
        ...
        value: function componentWillUnmount() {
          _get(WrappedComponent.prototype.__proto__ || Object.getPrototypeOf(WrappedComponent.prototype), 'componentWillUnmount', this) && _get(WrappedComponent.prototype.__proto__ || Object.getPrototypeOf(WrappedComponent.prototype), 'componentWillUnmount', this).call(this);
    ...
    }(Component), _class.displayName = 'Listen(' + (Component.displayName || Component.name || Component.prototype.constructor.name) + ')', _class.contextTypes = _extends({}, Component.contextTypes || {}, {
...
function listen(store) {
  var stateGetter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (state) {
    return state;
  };
